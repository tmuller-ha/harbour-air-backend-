...
export default factories.createCoreService(
  ...
  ({ strapi }: { strapi: Strapi }) => ({
    ...
    async delete(id) {
      return await strapi.entityService?.delete("plugin::forms.discounted-travel", id);
    },
    async update(id, data) {
        return await strapi.entityService?.update("plugin::forms.discounted-travel", id, {data});
    },
    async create(data) {
        return await strapi.entityService?.create("plugin::forms.discounted-travel", {data});
    }
  })
);
